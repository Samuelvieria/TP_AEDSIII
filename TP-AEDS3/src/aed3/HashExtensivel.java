...
public class HashExtensivel<T extends InterfaceHashExtensivel> {
  ...
  protected class Diretorio {
    ...
    protected boolean duplica() {
      if (profundidadeGlobal == 20)  // limite máximo de 1.048.576 cestos
        return false;
      profundidadeGlobal++;
    ...
    protected int hash2(int hashCode, int profundidadeLocal) { // cálculo do hash para uma dada profundidade local
  ...
  public boolean create(T elem) throws Exception {
    ...
    int inicio = diretorio.hash2(elem.hashCode(), pl);

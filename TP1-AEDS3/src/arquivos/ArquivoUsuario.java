...
public class ArquivoUsuario extends Arquivo<Usuario> {
    ...
    public ArquivoUsuario() throws Exception {
        ...
        if (DEBUG)
            System.out.println("ArquivoUsuario inicializado com sucesso.");
    }
    ...
    public Usuario readEmail(String email) throws Exception {
        ...
        if (DEBUG)
            System.out.println("Buscando email '" + email + "' com hash: " + hashCode);

        ParEmailId pei = indiceEmail.read(hashCode);
        if (pei == null) {
            if (DEBUG)
                System.out.println("Nenhum ParEmailId encontrado para hash.");
            return null;
        }
        ...
        if (!pei.getEmail().equals(email)) {
            if (DEBUG)
                System.out.println("Colisão de hash ou email diferente: " + pei.getEmail());
            return null;
        }
    ...
    public boolean update(Usuario novoUsuario) throws Exception {
        ...
        if (antigo == null) {
            if (DEBUG)
                System.out.println("Usuário não encontrado para update: ID " + novoUsuario.getID());
            return false;
        }
        ...
        if (emailAlterado) {
            ...
            if (DEBUG)
                System.out.println("Índice antigo removido: " + antigo.getEmail());
        }
        ...
        if (emailAlterado) {
            ...
            if (DEBUG)
                System.out.println("Novo índice criado: " + novoUsuario.getEmail());
        }
    ...
    public boolean delete(int id) throws Exception {
        ...
        if (u == null) {
            if (DEBUG)
                System.out.println("Tentativa de excluir usuário inexistente ID: " + id);
            return false;
        }
        ...
        if (DEBUG)
            System.out.println("Índice de email removido: " + indiceRemovido);
    ...
    public boolean recuperarSenha(String email, String resposta, String novaSenha) throws Exception {
        ...
        if (u == null)
            return false;
        if (!u.verificaResposta(resposta))
            return false;
    ...
    public void close() throws Exception {
        try {
            ...
            if (indiceEmail != null)
                indiceEmail.close();
            if (DEBUG)
                System.out.println("ArquivoUsuario fechado corretamente.");
        } catch (IOException e) {
